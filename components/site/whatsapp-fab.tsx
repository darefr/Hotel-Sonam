...
export function WhatsAppFab() {
  const href = whatsappLink("Hello Hotel Tukuche Peak, I have a question about booking a stay.")
  return (
    <a
      href={href}
      target="_blank"
      ...
      className="glass-strong glass-reflect fixed bottom-5 left-5 z-40 grid size-12 place-items-center rounded-full text-[#25D366] shadow-lg transition-transform hover:scale-105"
    >
